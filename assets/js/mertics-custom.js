      ...
      window.onscroll = function(){
        if (window.pageYOffset >100) {
         ...
         for (var i = 0; i < navlink_class.length; i++) {
           ...
           $("#nav_img").attr("src","/assets/img/hashnative-logo-nav.png");
        }else{
         ...
         $("#nav_img").attr("src","/assets/img/hashnative-logo-nav-2.png");
        }
      }


function googleMap() {
  var myCenter = new google.maps.LatLng(6.8981414,79.8530298);
