...
class Site extends CI_Controller {
	...
	{		
		$data['title']='Hashnative | Business Intelligence software company in Sri Lanka';		
	...
	{		
		if($vacancy=="all"){
			$data['title']='Careers | Hashnative - Business Intelligence software company in Sri Lanka';
			...
			$data['title']='Careers : '.urldecode($vacancy).' vacancy at Hashnative solutions';
			$this->load->view('template/header',$data);
			$this->load->view('template/navigation');
			$this->load->view('template/sections/pagetitle');
	...
	public function contact_Mail()
	{
		$config = Array(
			...
			'smtp_port' => 465,
  'smtp_user' => 'ilham@hashnative.com', // change it to yours
  ...
  'wordwrap' => TRUE
      ...
      $this->email->from('ilham@hashnative.com'); // change it to yours
      $this->email->to('hello@hashnative.com');// change it to yours
...
public function quarry(){
    $data['title']='Our Products | Business Intelligence software company in Sri Lanka';
    $data['heading']='It’s the quality that speaks; and the people that matter.';
    $data['page']='Products>>Quarry Management System';
    $data['background']=base_url('assets/img/banner/contact-banner.jpg');			
    $this->load->view('template/header',$data);
    $this->load->view('template/navigation');
    $this->load->view('template/sections/pagetitle');
    $this->load->view('template/external/quarry');
